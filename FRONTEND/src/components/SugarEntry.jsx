    ...
    <div className="fixed bottom-8 left-0 right-0 z-40 px-4">
      <div className="max-w-xl mx-auto relative">
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              ...
              <p className="text-[11px] text-zinc-500 mt-6 text-center font-medium">
                ✨ Gemini AI identifies ingredients & estimates metabolic load.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <motion.button
          ...
          className={`mx-auto h-20 neo-shadow rounded-[32px] flex items-center justify-center gap-4 transition-all ${
            isExpanded
              ? "w-20 bg-zinc-900 border border-white/20 text-white"
              : "w-full max-w-[280px] bg-white text-black"
          }`}
        >
          {isExpanded ? (
